...
(
    ...
    localparam PAD7 = log2ceil(64'h1109048 - 64'h1109040);
    localparam PAD8 = log2ceil(64'h1109050 - 64'h1109048);
    localparam PAD9 = log2ceil(64'h1109054 - 64'h1109050);
    localparam PAD10 = log2ceil(64'h1109056 - 64'h1109054);
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1109056;
    ...
    always @* begin
        ...
        // ( 0x1109048 .. 0x1109050 )
        if ( {address[RG:PAD8],{PAD8{1'b0}}} == 25'h1109048 ) begin
            src_channel = 11'b00000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
        end

        // ( 0x1109050 .. 0x1109054 )
        if ( {address[RG:PAD9],{PAD9{1'b0}}} == 25'h1109050 ) begin
            src_channel = 11'b10000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
        end

        // ( 0x1109054 .. 0x1109056 )
        if ( {address[RG:PAD10],{PAD10{1'b0}}} == 25'h1109054 ) begin
