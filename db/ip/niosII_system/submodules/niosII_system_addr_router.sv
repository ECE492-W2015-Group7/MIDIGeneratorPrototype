...
(
    ...
    localparam PAD10 = log2ceil(64'h1109064 - 64'h1109060);
    localparam PAD11 = log2ceil(64'h1109066 - 64'h1109064);
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1109066;
    ...
    always @* begin
        ...
        // ( 0x1109064 .. 0x1109066 )
        if ( {address[RG:PAD11],{PAD11{1'b0}}} == 25'h1109064 ) begin
